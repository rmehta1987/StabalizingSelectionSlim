...
def main():
    ...
    count = 0
    exprun='Slim_Run_Additive_Experiment_s_is_02'
    ...
    for i in range(1, 500):
        ...
        os.chdir(change_to)    
        process = subprocess.Popen(["slim", "../../additive_selection.slim"], stdout=subprocess.PIPE, stderr=subprocess.PIPE,universal_newlines=True)
